Hello and welcome to ski math!
Our website is not yet up and running on a server
Please Follow instructions to get progam running on your local machine
...
7. deactivate and exit pip shell (deactivate, exit)
